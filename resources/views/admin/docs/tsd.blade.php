    ...
    <div class="card-body">
        <table class="table table-bordered tsd-table">
            ...
            <tbody>
                ...
                <tr><td>Max size base64 image (DoS prevention)</td><td><span class="badge badge-implemented">Implemented</span></td><td><span class="evidence-tag">max:14000000</span> validation rule (maks. foto 10 MB)</td></tr>
