...
<div class="row">
        ...
        <div class="card card-info">
            ...
            <div class="card-body p-0 table-responsive dashboard-dwelling-table">
                <table class="table table-sm table-striped table-hover mb-0">
                    <thead><tr><th>NOKA</th><th>Dwelling Origin</th></tr></thead>
                    <tbody>
                        @forelse ($isoDwellingDetails['origin'] as $row)
                            <tr><td><code>{{ $row['identity'] ?? '-' }}</code></td><td>{{ number_format($row['days']) }} hari</td></tr>
                        @empty
    ...
    <div class="col-6">
        <div class="card card-success">
            ...
            <div class="card-body p-0 table-responsive dashboard-dwelling-table">
                <table class="table table-sm table-striped table-hover mb-0">
                    <thead><tr><th>NOKA</th><th>Dwelling Destination</th></tr></thead>
                    <tbody>
